    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium px-4 py-2.5 transition-colors"
        >
                    ...
                    <TableCell>
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                        ...
                        <select
                          ...
                          className="rounded-lg border border-slate-700 bg-slate-900 text-xs text-white px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 max-w-[160px]"
